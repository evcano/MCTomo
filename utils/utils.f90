...
contains
    ...
    function float_format(n)
        implicit none
        integer, intent(in) :: n
        character(len=fmt_len) :: float_format
        character(5) :: short_fmt='F7.4'

        write(float_format,'("(",I0,A,")")') n,short_fmt   ! define the integer format

    end function float_format
